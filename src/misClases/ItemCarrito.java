...
public class ItemCarrito extends javax.swing.JPanel {
    ...
    public double precioProductoCarrito() {
        double precio = producto.getPrecio() * (double) producto.getCantidad();
        return precio;
    }

    public double precioProductoCarritoExistente() {
        double precio = producto.getPrecio() * Double.parseDouble(lblCantidad.getText());
        return precio;
    }

    public String detalleProducto() {
        String producto = "";
        producto = "Producto: " + lblProducto.getText() + " Cantidad: " + lblCantidad.getText() + " Precio: "
                + lblPrecio.getText();
        return producto;
    }
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGap(24, 24, 24)
                                .addComponent(lblProducto, javax.swing.GroupLayout.PREFERRED_SIZE, 86,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(46, 46, 46)
                                .addComponent(lblPrecio, javax.swing.GroupLayout.PREFERRED_SIZE, 89,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(lblCantidad)
                                .addGap(59, 59, 59)
                                .addComponent(btnEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 94,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
